...
china_infected_pop = sum(total_cases_estraction_location(china_deaths, 'China')) / \
                     int(float(china_population))*100  #0.06%
#print(china_infected_pop)

india_infected_pop = sum(total_cases_estraction_location(india_deaths, 'India')) / \
                     int(float(india_population))*100  #3.16%
...
#china_people_vacc_percent = max(total_people_vaccinated(china_vacc, 'China')) / \
#                           int(float(china_population))*100  #91.36%
...
#india_people_vacc_percent = total_people_vaccinated(india_vacc, 'India')  / \
#                           int(float(china_population))*100 #72.92%

...
print('In Cina, la probabilità di morire se è stato contratto il COVID-19 è pari allo',
      format(china_death_prob,'.2f'),'%.\nLa percentuale di popolazione contagiata da COVID-19 è stata pari allo:',
      format(china_infected_pop,'.2f'),'% e la percentuale di popolazione con almeno una dose di vaccino è il 91.36%')

print('In India, la probabilità di morire se è stato contratto il COVID-19 è pari allo',
      format(india_death_prob,'.2f'),'%.\nLa percentuale di popolazione contagiata da COVID-19 è stata pari allo:',
      format(india_infected_pop,'.2f'),'% e la percentuale di popolazione con almeno una dose di vaccino è il 72.92%')
